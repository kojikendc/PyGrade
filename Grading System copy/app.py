...
def check_credentials(username, password):
    ...
    if result:
        stored_password_hash = result[1]  # The password field is at index 1
...
def register():
    ...
    try:
        ...
        if role == 'faculty':
            ...
            cursor.execute(sql, (full_name, username, hashed_password, role, department))
        else:
            if not student_id:
            ...
            cursor.execute(sql, (full_name, username, hashed_password, role, student_id))
